...
def main(unused_argv):
  ...
  for i in range(0, 44):
    ...
    convert_to(processed_train_images[st:en], train_label[st:en], 'orchid11-images-train-%d' % i)
    i += 1
    st += 20
    en += 20
  ...
  for i in range(0, 11):
    ...
    convert_to(processed_test_images[st:en], test_label[st:en], 'orchid11-images-test-%d' % i)
    i += 1
    st += 20
    en += 20
