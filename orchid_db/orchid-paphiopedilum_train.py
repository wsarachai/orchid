...
def get_bottleneck_path(image_lists, label_name, index, bottleneck_dir,
  ...
  return get_image_path(image_lists, label_name, index, bottleneck_dir,
                        category) + '_orchid-paphiopedilum.txt'
...
def save_graph_to_file(sess, graph, graph_file_name):
  output_graph_def = graph_util.convert_variables_to_constants(sess, graph.as_graph_def(), [FLAGS.final_tensor_name, 'final_result_dendrobium', 'final_result_bulbophyllum', 'final_result_genus'])
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-paphiopedilum_001/flower_photos',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-paphiopedilum_001/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-paphiopedilum_001/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-paphiopedilum_001/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-paphiopedilum_001/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-dendrobium_001',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-paphiopedilum_001/bottleneck',
      help='Path to cache bottleneck layer values as files.'
  )
  parser.add_argument(
      '--final_tensor_name',
      type=str,
      default='final_result_paphiopedilum',
      help="""\
