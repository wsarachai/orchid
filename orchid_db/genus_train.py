...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-genus/flower_photos',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-genus/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-genus/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-genus/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-genus/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-genus/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/Volumes/Data/_Corpus-data/orchid-genus/bottleneck',
      help='Path to cache bottleneck layer values as files.'
  )
  parser.add_argument(
      '--final_tensor_name',
      type=str,
      default='final_result_genus',
      help="""\
