...
if __name__ == "__main__":
  ...
  if running_method == 'accuracy':
    final_result_sensor = 'final_result_dendrobium:0'
    model_dir = '/Volumes/Data/_Corpus-data/models'
    labels = load_labels("{0}/{1}_output_label.txt".format(model_dir, 'dendrobium'))
    input_graph = os.path.join(model_dir, '{0}_output_graph.pb'.format('dendrobium'))
